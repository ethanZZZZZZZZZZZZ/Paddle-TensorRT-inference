...
public:
  YoloDecodePlugin(float score_threshold, float nms_threshold, int top_k,
  ...
  nvinfer1::DimsExprs
  getOutputDimensions(int output_index, const nvinfer1::DimsExprs *inputs,
                      int nb_inputs,
                      nvinfer1::IExprBuilder &expr_builder) noexcept override;
  bool supportsFormatCombination(int position,
  ...
  void
  attachToContext(cudnnContext *cudnn_context, cublasContext *cublas_context,
...
public:
  ...
  nvinfer1::IPluginV2 *createPlugin(const char *name,
                                    const nvinfer1::PluginFieldCollection
                                        *field_collection) noexcept override;
  nvinfer1::IPluginV2 *
  deserializePlugin(const char *name, const void *serial_data,
